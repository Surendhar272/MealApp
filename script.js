...
/**
 * Update the counter with the current number of items in the favorite list.
*/
    ...
    if (mealsData.meals) {
        html = mealsData.meals.map(element => {
            ...
            <div class="card-bottom">
                ...
                <span class="button" onclick="showMealDetails(${element.idMeal}, '${inputValue}')"><div class="text">Know More</div></span>
    ...
    if (mealDetails.meals) {
        ...
        <div class="container remove-top-margin">
            ...
            <div class="fixed" id="search-bar">
                ...
                <div class="icon">
                <button class="search-btn" onclick="showMealList()"> <i class="fa-solid fa-search "></i></button>
            </div>
            </div>
        </div>
